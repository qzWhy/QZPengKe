...
#define kLeftAlpha  0.9     //左侧蒙板的最大值
#define kLeftCenterX 30 //左侧初始偏移量
#define kLeftScale  0.7     //左侧初始缩放比例

#define vDeckCanNotPanViewTag   987654      //不响应侧滑的view的tag

#import <UIKit/UIKit.h>

@interface QZLeftSlideViewController : UIViewController
...
@property (nonatomic, assign) BOOL supportPoraitOnly;
@end
