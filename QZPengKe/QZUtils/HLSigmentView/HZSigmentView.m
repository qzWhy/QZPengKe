...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(collectionScrollTutorial:) name:@"HLTutorialHomePageController" object:nil];
    }
    return self;
}
...
-(void)setTitleArry:(NSArray *)titleArry {
    ...
    line.backgroundColor = QZHEXCOLOR(@"e8e8e8");
    ...
    self.bottomLine.backgroundColor =  QZHEXCOLOR(@"ff7888");
